...
type Message struct {
	...
	MessageContent string    `json:"message_content,omitempty" example:"Hi!"`                 // Message content
	...
	IsForwarded    bool      `json:"is_forwarded" example:"false"`                            // Check if message is forwarded
